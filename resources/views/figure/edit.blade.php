    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('figure.update')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="name" id="name" class="form-control" value="{{$figure->name}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="type" id="type" class="form-select w-100" data-type="{{$figure->type}}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="category" id="category" class="form-select w-100" data-category="{{$figure->category}}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="code" class="w-100" id="code" rows="12" required>{{$figure->code}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="description" class="w-100" id="description" rows="5">{{$figure->description}}</textarea>
                            </div>
                        </div>
